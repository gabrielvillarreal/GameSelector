...
public class inicio extends javax.swing.JFrame {
    ...
    public inicio() {
        ...
        this.tiempo = new Timer(10, accion); //10 nanosegundos, hace accion 
        this.tiempo.start();
        setTitle("Spirit Orbs Search"); //titulo de la pantalla
        
        initComponents();
        this.setResizable(false);
        this.setLocationRelativeTo(this);
        this.jPanel1.requestFocusInWindow(); //solicito el foco en la ventana
    ...
    private void refresh(){
        //lo cree yo. pintando inicio y espera cada cierto tiempo
        long inicio;
        long transcurrido;
        long espera;
        ...
        try {
            ...
            Thread.sleep(espera); //espera a que pinte todo esto y transcurre cada 30 frame por segundo

        } catch (InterruptedException ex) {
            ex.printStackTrace(); //nos muestre estras tracsas
        }
    }
